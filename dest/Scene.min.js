...
cssObject["-moz-"+property]=cssObject["-ms-"+property]=cssObject["-o-"+property]=cssObject["-webkit-"+property]=cssObject[property]};framePrototype.getCSSText=function(prefix){var property,cssObject=this.getCSSObject(),cssText="";cssObject.transform&&convertCrossBrowserCSSObject(cssObject,"transform"),cssObject.filter&&convertCrossBrowserCSSObject(cssObject,"filter");for(property in cssObject)cssText+=property+":"+cssObject[property]+";";return cssText}}()}();